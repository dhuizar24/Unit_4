...
def count_q_tips(list_choice):
    ...
    print(f"There are {count_q_tips} q-tips ") 
...
while True:
    user_choice = input("Choose 1 = update item, 2 = view item, or 3 = view list, 4 = combine all lists, 5 = count number of qtips in a list, 6 = add milk to lists, 7 = milk and cookies? or q for quit:")
    ...
    if user_choice == '1':
        ...
        list_choice = int(input("Which list contains the item you want to view?")) - 1
